...
def visual(input_data, prediction, label, mode, timeIdx):
    ...
    limit = [1, 288, 0, 300]
    danger  = [140 for i in range(1, 289)]
    """
    ...
    """
    plt.title("Together")
    plt.plot(test_predict_time, predict_graph[288:], color = 'green', label = 'Prediction')
    plt.plot(test_predict_time, true_graph[288:], color = 'blue', label = 'Real')
    plt.plot(test_predict_time,danger ,color = 'red', label = 'Danger')
